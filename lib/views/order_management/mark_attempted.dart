...
//// This will change transaction status to Attempted ////

class MarkAttempted extends StatefulWidget {
  const MarkAttempted({Key? key}) : super(key: key);

  @override
  _MarkAttemptedState createState() => _MarkAttemptedState();
}

class _MarkAttemptedState extends State<MarkAttempted> {
  ...
  Widget build(BuildContext context) {
    ...
    var markAttemptedButton = MyElevatedButton(
      text: 'Mark Attempted',
      btnBackgroundColor: MyColors.btnColorGreen,
      ...
      onPressed: () {
        if (selectedRider != null && selectedRider!.isNotEmpty) {
          if (selectedRecords.isNotEmpty) {
            Get.dialog(MyMarkAttemptConfirmationDialog(
